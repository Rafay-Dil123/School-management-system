...
const initialStudentData = {
  sectionA: [
    { rollNo: '01', name: 'Ali', subjects: { English: 86, Maths: 77, Science: 87, ComputerScience: 92, SocialStudies: 95 } },
    { rollNo: '02', name: 'rafay', subjects: { English: 86, Maths: 77, Science: 87, ComputerScience: 92, SocialStudies: 95 } },
    { rollNo: '03', name: 'moiz', subjects: { English: 86, Maths: 77, Science: 87, ComputerScience: 92, SocialStudies: 95 } },

   
    // Add more students for sectionA as needed
  ],
  sectionB: [
    { rollNo: '03', name: 'Shan', subjects: { English: 86, Maths: 77, Science: 87, ComputerScience: 92, SocialStudies: 95 } },
    // Add more students for sectionB as needed
  ],
  sectionC: [
    { rollNo: '05', name: 'Zeeshan', subjects: { English: 86, Maths: 77, Science: 87, ComputerScience: 92, SocialStudies: 95 } },
...
function Teachermarks() {
  ...
  const handleSaveMarks = () => {
    ...
    console.log(`Marks data for ${selectedSection} saved:`, studentData[selectedSection]);
